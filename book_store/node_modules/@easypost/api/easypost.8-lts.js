...
class API {
  ...
  async request(path = '', method = METHODS.GET, params = {}, headers = {}) {
    ...
    let req = this.agent[method](this.buildPath(path)).accept('json').set('Content-Type', 'application/json').set(API.buildHeaders(headers));
...
/******/ })));
//# sourceMappingURL=easypost.8-lts.js.map
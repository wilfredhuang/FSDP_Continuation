...
import { logRed, logGreen, logYellow, logCyan, } from "./helpers/loggerHelper.js";
/* ============================================================
...
app.use(async (req, res, next) => {
    try {
        ...
        const existingCoupon = await Coupon.findOne({ where: { public: 1 } });
        if (!existingCoupon) {
        ...
        logRed("❌ Error initializing session variables:", error.message);
    }
    next();
});
/* ============================================================
